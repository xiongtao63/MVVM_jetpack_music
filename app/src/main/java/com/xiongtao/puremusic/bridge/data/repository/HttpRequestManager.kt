package com.xiongtao.puremusic.bridge.data.repository
...
import com.xiongtao.puremusic.bridge.data.repository.api.WanAndroidAPI
import com.xiongtao.puremusic.bridge.data.repository.net.APIClient
import com.xiongtao.puremusic.bridge.data.repository.net.APIResponse
...
//        var type: List<TestAlbum> = listOf<TestAlbum>()
        val testAlbum =
